...
export interface ReviewActionVote {
  agentId: string
  agentName: string
  vote: ReviewEndVoteValue
  reason: string
...
export interface ReviewActionVoteSession {
  id: string
  requestedByAgentId: string
  requestedByAgentName: string
  ...
  previousRoundRejections?: Array<{ agentName: string; reason: string }>
